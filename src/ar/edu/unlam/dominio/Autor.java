...
public class Autor extends Persona {
	...
	public Autor(String nombre, String nacionalidad, Integer edad, String domicilio, Integer dni) {
		...
		this.librosEscritos = new CopiaLibro[4];
	...
	public String toString() {
		return "Autor " + getNombre() + " de nacionalidad " + getNacionalidad() + ",tiene " + getEdad() + " años "
				+ ", su domicilio es " + getDomicilio() + ", y su dni es " + getDni();
