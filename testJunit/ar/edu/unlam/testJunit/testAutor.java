...
public class testAutor {
	...
	public void queSePuedaAgregarAutor() {
		...
		Autor autor2 = new Autor("Gabriel García Márquez", "Colombiano", 87, "Cementerio Cartagena de Indias",
				17042017);
	...
	public void queSePuedaAgregarUnLibroPorAutor() {
		...
		CopiaLibro ficciones = new CopiaLibro("Ficciones", Genero.NOVELA, 1985, autor1, "editorial", 30000.0, 5);
